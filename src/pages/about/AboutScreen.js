      ...
      <div className="p-4">
        <div className="bg-white rounded-xl p-3 font-title">
          ...
          <div className="mt-4 mb-5 flex flex-row items-center">
            ...
            <div>
              <a
                href="https://github.com/Moksh91119"
                target={"_blank"}
                className="underline cursor-pointer"
                rel="noreferrer"
              >
                Hi, myself Moksh Jain
              </a>
          ...
          <div className="font-title mt-3 mb-5">
            <div>
              ...
              (or){" "}
              <a
                href="https://www.linkedin.com/in/moksh-jain-51271b194/"
                target={"_blank"}
                className="underline cursor-pointer"
                rel="noreferrer"
              >
            ...
            <div>
              <span>👨‍💻 </span>
              <a
                href="https://github.com/Moksh91119/invoice-maker"
                className="underline cursor-pointer"
                target={"_blank"}
                rel="noreferrer"
              >
          ...
          Mail to: {" "}
            <a
              href="mailto:jainmoksh03@gmail.com"
              className="underline cursor-pointer"
              target={"_blank"}
              rel="noreferrer"
            >
              {" "}
               jainmoksh03@gmail.com
            </a>
          </div>
        </div>
      </div>
